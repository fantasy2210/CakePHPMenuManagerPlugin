<div class="x_panel">
    <div class="x_title">
        <h2><?php echo __('Edit Menu Item'); ?></h2>        
    ...
    <div class="x_content">
        ...
        <?php echo $this->Form->create('MenuItem', array(
            ...
            'after' => '</div>'))); ?>
						...
						<?php echo $this->Form->input('parent_id', array('class' => 'form-control col-md-7 col-xs-12','label'=>array('class'=>'control-label col-md-3 col-sm-3 col-xs-12'))); ?>
						<?php echo $this->Form->input('lft', array('class' => 'form-control col-md-7 col-xs-12','label'=>array('class'=>'control-label col-md-3 col-sm-3 col-xs-12'))); ?>
						<?php echo $this->Form->input('rght', array('class' => 'form-control col-md-7 col-xs-12','label'=>array('class'=>'control-label col-md-3 col-sm-3 col-xs-12'))); ?>
						...
						<?php echo $this->Form->input('separator', array('class' => 'form-control col-md-7 col-xs-12','label'=>array('class'=>'control-label col-md-3 col-sm-3 col-xs-12'))); ?>
						<?php echo $this->Form->input('children', array('class' => 'form-control col-md-7 col-xs-12','label'=>array('class'=>'control-label col-md-3 col-sm-3 col-xs-12'))); ?>
						...
						<?php echo $this->Form->input('ulId', array('class' => 'form-control col-md-7 col-xs-12','label'=>array('class'=>'control-label col-md-3 col-sm-3 col-xs-12'))); ?>
						...
						<?php echo $this->Form->input('level', array('class' => 'form-control col-md-7 col-xs-12','label'=>array('class'=>'control-label col-md-3 col-sm-3 col-xs-12'))); ?>
